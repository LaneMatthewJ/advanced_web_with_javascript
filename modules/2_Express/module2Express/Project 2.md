...
For your second project, you need to run a local mongo db instance. For this project, you'll need to create a server which connects to a database. The database will house a certain number of posts from specific users. 
...
Your project should use at least one middleware. At the very least, you must use a body parser middleware.

Your project also needs to have a README describing how to use each endpoint. Without documentation, it is not easy to figure out how a service should be called. 

**Recommendations:**

You should at first get your endpoints running before you attempt to connect to connect to `jsonplaceholder` or create a mongo db instance. Use this fake data to get your project going similar to how it was done in the notes.

**Submission:**

In order to properly grade this project, you will need to not only submit your project (without node modules), but also an export of your mongo DB (which we will cover in class). 
